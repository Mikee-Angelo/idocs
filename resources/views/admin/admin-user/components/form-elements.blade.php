...
<div  v-if="form.roles != null && form.roles.length != 0 && form.roles[0].id != 1" class="form-group row align-items-center" :class="{'has-danger': errors.has('school_id'), 'has-success': fields.school_id && fields.school_id.valid }">
    <label for="school_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.admin-user.columns.school_id') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
        <select class="form-control" v-model="form.school_id"  v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('school_id'), 'form-control-success': fields.school_id && fields.school_id.valid}" id="school_id" name="school_id" placeholder="{{ trans('admin.admin-user.columns.school_id') }}">
