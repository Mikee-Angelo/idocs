        ...
        <div class="card">
            <div class="card-header"> 
                ...
                @if($data->status == 0 && Auth::user()->roles()->pluck('id')[0] == 1)
                    <form @submit.prevent="proposalStatus('{{$data['id']}}/change-status', true)">
                    ...
                    <form @submit.prevent="proposalStatus('{{$data['id']}}/change-status', false)">
                ...
                @endif
                <i class="fa fa-align-justify"></i> {{ trans('admin.reimbursement.actions.index') }} No. : {{$data->prop_no}}
            ...
            <div class="card-body">
                ...
                <div class="col-12 mx-auto border p-5 mt-5">
                    <div class="row">
                        <div class="col-3 text-right">
                            <img src="{{url('public/images/logo.png')}}" style="height:5rem" alt="">
                        </div>
