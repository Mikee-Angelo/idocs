            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/units/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.unit.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'name'">{{ trans('admin.unit.columns.name') }}</th>
                                        <th is='sortable' :column="'added_by'">{{ trans('admin.unit.columns.added_by') }}</th>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/units/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.unit.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
