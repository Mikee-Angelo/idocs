<div  class="form-group row align-items-center" :class="{'has-danger': errors.has('header'), 'has-success': fields.header && fields.header.valid }">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.header" v-validate="''" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('header'), 'form-control-success': fields.header && fields.header.valid}" id="header" name="header" placeholder="{{ trans('admin.accomplishment.columns.header') }}">
