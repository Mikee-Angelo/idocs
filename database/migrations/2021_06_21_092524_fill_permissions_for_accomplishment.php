...
class FillPermissionsForAccomplishment extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAccomplishment constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.accomplishment.index',
            'admin.accomplishment.create',
            'admin.accomplishment.show',
            'admin.accomplishment.edit',
            'admin.accomplishment.delete',
            'admin.accomplishment.bulk-delete',
        ]);
