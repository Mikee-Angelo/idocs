...
class FillPermissionsForGadPlanList extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGadPlanList constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gad-plan-list',
            'admin.gad-plan-list.index',
            'admin.gad-plan-list.create',
            'admin.gad-plan-list.show',
            'admin.gad-plan-list.edit',
            'admin.gad-plan-list.delete',
            'admin.gad-plan-list.bulk-delete',
        ]);
