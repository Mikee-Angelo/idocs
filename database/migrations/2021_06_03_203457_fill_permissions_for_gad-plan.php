...
class FillPermissionsForGadPlan extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGadPlan constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gad-plan',
            'admin.gad-plan.index',
            'admin.gad-plan.create',
            'admin.gad-plan.show',
            'admin.gad-plan.edit',
            'admin.gad-plan.delete',
            'admin.gad-plan.bulk-delete',
        ]);
