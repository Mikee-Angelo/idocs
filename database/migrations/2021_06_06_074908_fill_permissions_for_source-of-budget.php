...
class FillPermissionsForSourceOfBudget extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSourceOfBudget constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.source-of-budget',
            'admin.source-of-budget.index',
            'admin.source-of-budget.create',
            'admin.source-of-budget.show',
            'admin.source-of-budget.edit',
            'admin.source-of-budget.delete',
            'admin.source-of-budget.bulk-delete',
        ]);
