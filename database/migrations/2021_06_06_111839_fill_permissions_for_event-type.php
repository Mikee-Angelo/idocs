...
class FillPermissionsForEventType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEventType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.event-type.show',
            'admin.event-type.edit',
            'admin.event-type.delete',
            'admin.event-type.bulk-delete',
        ]);
