...
class FillPermissionsForRelevantAgency extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRelevantAgency constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.relevant-agency',
            'admin.relevant-agency.index',
            'admin.relevant-agency.create',
            'admin.relevant-agency.show',
            'admin.relevant-agency.edit',
            'admin.relevant-agency.delete',
            'admin.relevant-agency.bulk-delete',
        ]);
