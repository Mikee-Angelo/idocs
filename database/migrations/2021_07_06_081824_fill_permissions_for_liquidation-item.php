...
class FillPermissionsForLiquidationItem extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLiquidationItem constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.liquidation-item',
            'admin.liquidation-item.index',
            'admin.liquidation-item.create',
            'admin.liquidation-item.show',
            'admin.liquidation-item.edit',
            'admin.liquidation-item.delete',
            'admin.liquidation-item.bulk-delete',
        ]);
