...
class FillPermissionsForLiquidation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLiquidation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.liquidation',
            'admin.liquidation.index',
            'admin.liquidation.create',
            'admin.liquidation.show',
            'admin.liquidation.edit',
            'admin.liquidation.delete',
            'admin.liquidation.bulk-delete',
        ]);
